...
implements MouseListener, ActionListener, WindowListener
{
    ...
    public void mouseClicked(MouseEvent e) { Graphics2D g2;
        ...
        for (this.i = 0; this.i < 3; this.i += 1)//--------checking vertically
        {
            if ((this.ch[this.i] != 'B') &&
        ...
        for (this.i = 0; this.i < 7; this.i += 1)//-------checking horizontally
        {
            if (this.ch[this.i] != 'B')
            {
